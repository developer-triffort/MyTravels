...
- (void)uploadPicture:(UIImage *)picture withMessage:(NSString *)message {
    iPadPixAppDelegate *delegate =(iPadPixAppDelegate *) [[UIApplication sharedApplication] delegate];
    
//    NSString *consumerKey = [delegate.twitterSettings valueForKey:@"consumerKey"];
//    NSString *consumerSecret = [delegate.twitterSettings valueForKey:@"consumerSecret"]; 
    
    NSString *consumerKey = @"SqAdyUQ1eVZBl3x9qSgXHA";
    NSString *consumerSecret = @"ZATLmk2ZBjXJ3HlEKGL2KSc5oC5kLzpOvttx2oo2BA";
...
//      NSString *consumerSecret = @"ZATLmk2ZBjXJ3HlEKGL2KSc5oC5kLzpOvttx2oo2BA";
    ...
    [request addPostValue:consumerKey forKey:@"consumer_token"];
    [request addPostValue:consumerSecret forKey:@"consumer_secret"];
