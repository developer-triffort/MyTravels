...
- (SA_OAuthTwitterEngine *) initOAuthWithDelegate: (NSObject *) delegate {
    if (self = (id) [super initWithDelegate: delegate]) {
		self.requestTokenURL = [NSURL URLWithString: @"http://www.tumblr.com/oauth/request_token"];
		self.accessTokenURL = [NSURL URLWithString: @"http://www.tumblr.com/oauth/access_token"];
