...
static NSString *tumblrConsumerKey = @"pYdiUt3V5aJ8f1gZ9xJ5ordfW4IgB17Nf5jDJ4weuuM8hNFlKq";
static NSString *tumblrConsumerSecret = @"nUX9QCGNe8c2Vigi8hjeWyzmES800Q6TybLE7wmlJRct5fpaTP";
...
- (void) signAndSendWithTokenKey:(NSString *)key andSecret:(NSString *)secret {
    [self signRequestWithClientIdentifier:TUMBLR_OUTH_KEY secret:TUMBLR_OUTH_SECRET_KEY tokenIdentifier:key secret:secret usingMethod:ASIOAuthHMAC_SHA1SignatureMethod2];
