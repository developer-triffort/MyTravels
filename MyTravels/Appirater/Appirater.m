...
//  Lunch Facts
//
//  Created by Rahul Jain on 1/19/12.
//  Copyright 2012 triffort. All rights reserved.
//
...
//NSString *templateReviewURL = @"http://itunes.apple.com/WebObjects/MZStore.woa/wa/viewContentsUserReviews?type=Purple+Software&id=APP_ID";
...
+ (void)appLaunched:(BOOL)canPromptForRating {
    ...
    if(![[NSUserDefaults standardUserDefaults] boolForKey:kAppiraterRatedCurrentVersion])
    {
